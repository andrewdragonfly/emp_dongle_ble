...
#define DEVICE_NAME                     SERIAL                              /**< Name of device. Will be included in the advertising data. */
...
void internal_log_request_enable (){
  ...
  log_request_chunker('C','1',MOD1_CAP,6);
  log_request_chunker('C','2',MOD2_CAP,6);
  log_request_chunker('C','3',MOD3_CAP,6);
  log_request_chunker('C','4',MOD4_CAP,6);
  log_request_chunker('C','5',MOD5_CAP,6);
  log_request_chunker('C','6',MOD6_CAP,6);
  log_request_chunker('C','7',MOD7_CAP,6);
  log_request_chunker('C','8',MOD8_CAP,6);

  log_request_chunker('V','1',MOD1_VOLT,6);
  log_request_chunker('V','2',MOD2_VOLT,6);
  log_request_chunker('V','3',MOD3_VOLT,6);
  log_request_chunker('V','4',MOD4_VOLT,6);
  log_request_chunker('V','5',MOD5_VOLT,6);
  log_request_chunker('V','6',MOD6_VOLT,6);
  log_request_chunker('V','7',MOD7_VOLT,6);
  log_request_chunker('V','8',MOD8_VOLT,6);

  log_request_chunker('C','C',CC_COEF,6);
  log_request_chunker('S','V',SV_COEF,6);
...
void send_dev_defines (){
  ...
  apend_buff(HW_VERSION,sizeof(HW_VERSION));
...
void send_dev_defines_uart (uint8_t data_enum, uint8_t sub_enum){
  ...
  switch (data_enum){
    ...
    case 5://voltage
      switch (sub_enum){
        case 1:
          apend_buff(MOD1_VOLT,sizeof(MOD1_VOLT));
        break;
        case 2:
          apend_buff(MOD2_VOLT,sizeof(MOD2_VOLT));
        break;
        case 3:
          apend_buff(MOD3_VOLT,sizeof(MOD3_VOLT));
        break;
        case 4:
          apend_buff(MOD4_VOLT,sizeof(MOD4_VOLT));
        break;
        case 5:
          apend_buff(MOD5_VOLT,sizeof(MOD5_VOLT));
        break;
        case 6:
          apend_buff(MOD6_VOLT,sizeof(MOD6_VOLT));
        break;
        case 7:
          apend_buff(MOD7_VOLT,sizeof(MOD7_VOLT));
        break;
        case 8:
          apend_buff(MOD8_VOLT,sizeof(MOD8_VOLT));
        break;
    }
    break;
    ...
    case 6: //cap
      switch (sub_enum){
        case 1:
          apend_buff(MOD1_CAP,sizeof(MOD1_CAP));
        break;
        case 2:
          apend_buff(MOD2_CAP,sizeof(MOD2_CAP));
        break;
        case 3:
          apend_buff(MOD3_CAP,sizeof(MOD3_CAP));
        break;
        case 4:
          apend_buff(MOD4_CAP,sizeof(MOD4_CAP));
        break;
        case 5:
          apend_buff(MOD5_CAP,sizeof(MOD5_CAP));
        break;
        case 6:
          apend_buff(MOD6_CAP,sizeof(MOD6_CAP));
        break;
        case 7:
          apend_buff(MOD7_CAP,sizeof(MOD7_CAP));
        break;
        case 8:
          apend_buff(MOD8_CAP,sizeof(MOD8_CAP));
        break;
        }
    break;

    case 7:
     apend_buff(CC_COEF,sizeof(CC_COEF));
    break;

    case 8:
     apend_buff(SV_COEF,sizeof(SV_COEF));
    break;
  }
